            ...
            <View style={styles.imageUploadSection}>
              ...
              <View style={styles.imageUploadBox}>
                <MaterialCommunityIcons
                  ...
                  color="#a0aec0"
                />
                <Text style={styles.imageUploadText}>Upload a cover photo</Text>
              </View>
            </View>
            ...
            >
              ...
              <View style={styles.formSection}>
                ...
                <Text style={styles.eventTypeSubtitle}>
                  Choose who can join your event
                </Text>
                <View style={styles.eventTypeToggle}>
                  <TouchableOpacity
                    ...
                    onPress={() => setEventTypeFilter("Private")}
                  >
                    <Text
                      style={[
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => setEventTypeFilter("Public")}
                  >
                    <Text
                      style={[
                        styles.eventTypeButtonText,
